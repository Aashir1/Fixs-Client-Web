...
const MyMapComponent = compose(
    ...
    <GoogleMap
        defaultZoom={15}
        defaultCenter={props.coordinates[0]}
        accuracy={props.accuracy}
    >
        {props.isMarkerShown && <Marker position={props.coordinates[0]} onClick={props.onMarkerClick} />}
        <Polyline
        ...
        />
        {props.isMarkerShown && <Marker position={props.coordinates[props.coordinates.length - 1]} onClick={props.onMarkerClick} />}
    </GoogleMap>
)
